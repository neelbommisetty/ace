...
/**
 * /activity — the live AI run feed. Seeded from the server on mount, then
 * kept live over SSE; re-seeded on every SSE `hello` because the stream has
 * no replay — chunks missed in a reconnect gap are unrecoverable here, but
 * the ≤1s-stale persisted text always is (expanded steps lazy-fetch it).
 */
